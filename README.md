...
On the user side, TextMorph offers enhanced **profile personalization and security management**. Users can update their account details, securely change passwords, and upload profile avatars to personalize their experience. The platform also includes UI/UX enhancements such as a responsive layout, modern dashboard design, and intuitive navigation, ensuring a smooth and engaging user journey.
...
| Model Name | Organization | Task |
|------------|-------------|------|
| PEGASUS | Google Research | Summarization |
| FLAN-T5 | Google Research | Q&A |
| DistilBART | Meta AI | Summarization |
| BART Paraphrase | Meta AI | Paraphrasing |
| T5 Paraphrase | HuggingFace | Paraphrasing |
| OPUS-MT | Helsinki | Translation |
